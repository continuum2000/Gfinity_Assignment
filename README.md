...
- I have made 2 main sections, one for each page I needed to create. The general idea is my thought process making the page from top to bottom.
...
- I would have like to use a v-for loop to display the key - stat values but I couldnt think of a way that would allow me
  to match the key to the correct display name ie: key "sprintSpeed" should read "Sprint Speed". probably could just make a function taking the key value and returning the correct display name
